  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p>
        ...
        applications as a Full Stack Developer since 2006. I've been in multiple
        positions thoughtout my career, from a software developer, lead
        developer, CTO, and <strong>Head of Research and Development</strong>.
        The objective on each project is to create useful tools that make impact
        on users.
      </p>
      I've being using different technologies over the time:
      <ul>
        <li>
          on the server side I have created products with Ruby, PHP, Node.js and
          roughtly with Golang on Microservices,
        </li>
        <li>
          on the client side, I've passed from the origins of the web, using
          VanillaJS, jQuery, to jump to AngularJS, Angular 2 and finally React.
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        <strong>
          position their users (robots and people) indoors while doing Bussiness
          Intelligence
        </strong>{' '}
        on gathered data.
      </p>
      <p>
        ...
        performance and heavy loaded systems that helped journalists to maintain{' '}
        <strong>online newspapers</strong>, developing{' '}
        <a
      ...
      <p>
        ...
        <strong>I've developed a custom Linux-based desktop</strong> in order to
        simplify administrative tasks and also doing massive migrations to open
        source sofware in educational settings. This project 
        <a
      ...
      <p>
        ...
        👨‍💻 like <strong>GNOME</strong> (as a member of the GNOME Foundation) or
        in Ubuntu as Galician translators coordinator, 
        <a
      ...
      <p>
        Currently I'm <strong>not available for hire</strong> but you can write
        me to propose me future and innovative projects.
      </p>
    </Layout>
  );
};
