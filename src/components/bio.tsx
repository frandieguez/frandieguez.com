...
const Bio = ({ variant = 'simple' }) => {
  const { author, twitter, avatar, avatarBig } = useStaticQuery(bioQuery);
        ...
        <div className={bioStyles.heroWrapper}>
          ...
          <div className={bioStyles.heroText}>
            ...
            <h2 className={bioStyles.subhero}>
              A <strong>software developer</strong> who lives and works in Spain
              building useful things.
              <br />
            </h2>
            <p>
              No matter the position I've been in my career, software developer,
              Tech Lead, Head of Research and Development or CTO, my main focus
              always is to create useful tools that make impact on users.
            </p>
          </div>
        </div>
